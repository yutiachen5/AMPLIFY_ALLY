...
def trainer(cfg: DictConfig) -> None:
    ...
    # Get loss functions
    train_loss_fn = get_loss(accelerator.device, "mean", **cfg.tokenizer, **cfg.trainer.train, dtype=dtype_class_weight)
    val_loss_fn = get_loss(accelerator.device, "mean", **cfg.tokenizer, **cfg.trainer.validation, dtype=dtype_class_weight)
